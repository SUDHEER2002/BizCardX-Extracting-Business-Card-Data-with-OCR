...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='sudheer', auth_plugin='mysql_native_password')
...
icon = Image.open("C:\\Users\\DELL\\OneDrive - Amrita vishwa vidyapeetham\\Desktop\\New folder (3)\\business_card_home.jpeg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By B.V.SUDHEER",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *B.V.SUDHEER*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\DELL\\OneDrive - Amrita vishwa vidyapeetham\\Desktop\\New folder (3)\\business_card_home.jpeg"), width=500)
...
if selected == "Delete":
    ...
    with col2:
        ...
        designation = ["Select"]
        for j in Z:
            designation.append(j[0]) # type: ignore
